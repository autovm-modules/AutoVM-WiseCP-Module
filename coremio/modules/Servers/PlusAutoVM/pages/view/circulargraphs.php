    ...
    <div class="col-12 col-md-8 col-xxl-9 p-0 m-0 mb-3 pe-md-2 pe-xxl-0">
        <div class="row border border-2 rounded-4 bg-white m-0 p-0 me-xxl-2 h-100 align-items-center">
            ...
            <div class="d-flex flex-column col-6 col-sm-6 col-md-4 m-0 p-0 justify-content-center align-items-center ">
                ...
                <div v-if="isVisibe" class="row w-100 m-0 p-0">
                    <div v-if="detailIsLoaded && machineIsLoaded" class="d-flex flex-column m-0 p-0 justify-content-center align-items-center w-100 mb-3">
                        <div v-if="!theMemoryLimit || !memoryUsage" class="text-center p-0 m-0 alert alert-danger py-2 px-3 mx-3">
                            ...
                            <span v-if="!theMemoryLimit && !memoryUsage">
                                Err: No MemoryLimit & Memory Usage
                            </span>    
                        </div>
                    </div>
                </div>
            ...
            <div class="d-flex flex-column col-6 col-sm-6 col-md-4 m-0 p-0 justify-content-center align-items-center ">
                ...
                <div v-if="isVisibe" class="row w-100 m-0 p-0">
                    <div v-if="detailIsLoaded && machineIsLoaded" class="d-flex flex-column m-0 p-0 justify-content-center align-items-center w-100 mb-3">
                        <div v-if="!theCpuLimit || !cpuUsage" class="text-center p-0 m-0 alert alert-danger py-2 px-3 mx-3">
            ...
            <div class="d-flex flex-column col-6 col-sm-6 col-md-4 m-0 p-0 justify-content-center align-items-center">
                ...
                <div v-if="isVisibe" class="row w-100 m-0 p-0">
                    <div v-if="detailIsLoaded && machineIsLoaded" class="d-flex flex-column m-0 p-0 justify-content-center align-items-center w-100 mb-3">
                        <div v-if="!diskSize || !diskUsage" class="text-center p-0 m-0 alert alert-danger py-2 px-3 mx-3">
                            ...
                            <span v-if="!diskSize && !diskUsage">
                                Err: No Disksize nor Disk Usage
                            </span>    
                        </div>
                    </div>
                </div>
        ...
        <div class="m-0 p-0 h-100">
            <div class="row m-0 p-0">
                ...
                <div class="col-6 col-lg-6 m-0 p-0 px-1 mb-2">
                    <div @click="doReboot" data-bs-toggle="modal" data-bs-target="#processingModal" class="border border-2 rounded-4 bg-white m-0 p-0 py-5 py-md-3 py-xl-5 px-3 mx-0 pt-md-5 text-center">
                        <img class="btn p-0 m-0" src="/coremio/modules/Servers/PlusAutoVM/pages/view/assets/img/resetbtn.svg" width=35 alt="internet">
                ...
                <div @click="doStop" data-bs-toggle="modal" data-bs-target="#processingModal"
                    ...
                    <div
                        ...
                        <img class="btn p-0 m-0" src="/coremio/modules/Servers/PlusAutoVM/pages/view/assets/img/offbtn.svg" width=35 alt="internet">
                ...
                <div @click="doConsole" data-bs-toggle="modal" data-bs-target="#processingModal"
                    ...
                    <div
                        class="border border-2 rounded-4 bg-white m-0 p-0 py-5 py-md-3 py-xl-5 px-3 mx-0 pt-md-5 text-center">
                        <img class="btn p-0 m-0" src="/coremio/modules/Servers/PlusAutoVM/pages/view/assets/img/setupbtn.svg" width=35 alt="internet">
                ...
                <div @click="doStart" data-bs-toggle="modal" data-bs-target="#processingModal"
                    ...
                    <div
                        class="border border-2 rounded-4 bg-white m-0 p-0 py-5 py-md-3 py-xl-5 px-3 mx-0 pt-md-5 text-center">
                        <img class="btn p-0 m-0" src="/coremio/modules/Servers/PlusAutoVM/pages/view/assets/img/onbtn.svg" width=35 alt="internet">
