            ...
            <div class="col-12">
                ...
                <div class="row my-5">
                    <div class="col-4 col-md-2 p-0 m-0 text-start">
                        <img src="/coremio/modules/Servers/PlusAutoVM/pages/view/assets/img/cpuicon.svg" alt="cpuicon">
                ...
                <div class="row my-5">
                    <div class="col-4 col-md-2 p-0 m-0 text-start">
                        <img src="/coremio/modules/Servers/PlusAutoVM/pages/view/assets/img/ramicon.svg" alt="cpuicon">
                        <span class="p-0 m-0 ps-1 ps-md-3">
                            {{ lang('memory') }}
                        </span>
                    </div>
                ...
                <div class="row my-5">
                    <div class="col-4 col-md-2 p-0 m-0 text-start">
                        <img src="/coremio/modules/Servers/PlusAutoVM/pages/view/assets/img/diskicon.svg" alt="cpuicon">
                        <span class="p-0 m-0 ps-1 ps-md-3">
                            {{ lang('disk') }}
                        </span>
                    </div>
